    ...
    return res.send(`
      <html>
        ...
        <body style="font-family: system-ui; display: flex; align-items: center; justify-content: center; min-height: 100vh; margin: 0; background: #0a0a0a;">
          <div style="text-align: center; background: #141414; padding: 2.5rem; border-radius: 16px; box-shadow: 0 2px 24px rgba(0,0,0,0.4); max-width: 460px; border: 1px solid rgba(232,196,104,0.15);">
            ...
            <p style="color: #888; margin: 0 0 1.75rem; line-height: 1.6;">Check your phone. GymBuddy will call you shortly to set your workout schedule. If calling is unavailable, we will text you instead.</p>
