...
interface StaggeredMenuProps {
    ...
    hideHeader?: boolean; // Added hideHeader to props
    onMenuOpen?: () => void;
    onMenuClose?: () => void;
}
...
export const StaggeredMenu = forwardRef<StaggeredMenuHandle, StaggeredMenuProps>(({
    ...
    hideHeader = false, // Added hideHeader default value
    onMenuOpen,
    onMenuClose
}, ref) => {
    ...
    const playClose = useCallback(() => {
        ...
        closeTweenRef.current = gsap.to(all, {
            ...
            onComplete: () => {
                ...
                const socialTitleEl = panel.querySelector('.sm-socials-title') as HTMLElement | null;
                const socialLinkEls = Array.from(panel.querySelectorAll('.sm-socials-link')) as HTMLElement[];
                if (socialTitleEl) gsap.set(socialTitleEl, { opacity: 0 });
